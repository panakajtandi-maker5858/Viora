                    ...
                    <form onSubmit={handleSubmit} className="pt-14 pb-24">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 lg:items-start">
                            ...
                            <div className="flex flex-col gap-12">
                                ...
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="cp-title" className="text-[10px] uppercase tracking-[0.2em] font-medium" style={{ color: '#7A6E63' }}>
                                        Product Title
                                    </label>
                                    <input
                                ...
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="cp-description" className="text-[10px] uppercase tracking-[0.2em] font-medium" style={{ color: '#7A6E63' }}>
                                        Description
                                    </label>
                                    <textarea
                                        id="cp-description" name="description"
                                        value={formData.description} onChange={handleChange}
                                        rows={5} placeholder="Describe the product — material, fit, details..."
                                    ...
                                    <div className="flex gap-5 items-end">
                                        <div className="flex flex-col gap-1 flex-[3]">
                                            ...
                                            <input
                                                ...
                                                value={formData.priceAmount} onChange={handleChange} required
                                        ...
                                        <div className="flex flex-col gap-1 flex-[1]">
                                            ...
                                            <select
                                                ...
                                                className="w-full bg-transparent outline-none py-4 text-sm cursor-pointer appearance-none"
                                                style={inputStyle} onFocus={handleFocus} onBlur={handleBlur}
                                            >
                                                {CURRENCIES.map(c => (
                                                    <option key={c} value={c} style={{ backgroundColor: '#fbf9f6' }}>{c}</option>
                                                ))}
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    >
                                        ...
                                        <div className="text-center">
                                            <p className="text-sm leading-relaxed" style={{ color: '#7A6E63' }}>
                                                Drop images here or{' '}
                                                <span style={{ color: '#C9A96E', textDecoration: 'underline' }}>
                                                    tap to upload
                                                </span>
                                            </p>
                                ...
                                {images.length > 0 && (
                                    <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-3 xl:grid-cols-4 gap-2 mt-1">
                                        {images.map((img, index) => (
                                            <div key={index} className="relative aspect-square overflow-hidden group" style={{ backgroundColor: '#eae8e5' }}>
                        ...
                        <div className="mt-16 lg:mt-20">
                            <button
                                ...
                                className="w-full py-5 text-[11px] uppercase tracking-[0.3em] font-medium transition-all duration-300 disabled:opacity-50"
                                style={{ backgroundColor: isSubmitting ? '#7A6E63' : '#1b1c1a', color: '#fbf9f6' }}
