...
const SellerProductDetails = () => {
    ...
    if (loading) {
        return (
            <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#fbf9f6' }}>
                <p style={{ fontFamily: "'Inter', sans-serif", color: '#B5ADA3' }} className="text-[10px] uppercase tracking-[0.2em] animate-pulse">
                    Loading gallery...
                </p>
            </div>
        );
    ...
    if (!product) {
        return (
            <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#fbf9f6' }}>
                <p style={{ fontFamily: "'Inter', sans-serif", color: '#B5ADA3' }} className="text-[10px] uppercase tracking-[0.2em]">
                    Product Not Found
                </p>
            </div>
        );
                        ...
                        <div className="bg-white p-6 md:p-8 mb-12 shadow-[0_20px_40px_rgba(27,28,26,0.04)]">
                                                ...
                                                <div key={index} className="flex gap-2 items-center">
                                                    ...
                                                    {attributeInputs.length > 1 && (
                                                        <button
                                                            ...
                                                            className="text-red-600 p-2 hover:bg-red-50 transition-colors cursor-pointer"
                                                        >
                                                            <TrashIcon />
                                                        </button>
                                                    )}
                                            ...
                                            {newVariant.images.map((img, index) => (
                                                <div key={index} className="relative aspect-[4/5] bg-[#f5f3f0]">
                                                    ...
                                                    <button
                                                        ...
                                                        className="absolute top-1 right-1 bg-white/80 p-1 text-red-600 hover:bg-white transition-colors cursor-pointer"
                                                    >
                                                        <TrashIcon />
                                                    </button>
                                                </div>
                                    ...
                                    {newVariant.images.length < 7 && (
                                        <input
                                            ...
                                            className="block w-full text-sm text-[#6e6258]
                                                ...
                                                file:uppercase file:text-xs file:tracking-wider file:font-serif
                                                cursor-pointer"
                                        />
                                    )}
                                </div>
                            ...
                            <div className="mt-10 flex justify-end">
                                <button
                                    ...
                                    className="bg-gradient-to-r from-[#745a27] to-[#c9a96e] text-white px-8 py-3 uppercase tracking-wider text-sm hover:opacity-90 transition-opacity cursor-pointer"
                                >
                                    Save Variant
                                </button>
                            </div>
