                    ...
                    <div className="w-full max-w-sm">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-9">
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="reg-fullName" className="text-[10px] uppercase tracking-[0.18em] font-medium" style={{ color: '#7A6E63' }}>
                                    Full Name
                                </label>
                                <input
                                    id="reg-fullName" type="text" name="fullName"
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="reg-contact" className="text-[10px] uppercase tracking-[0.18em] font-medium" style={{ color: '#7A6E63' }}>
                                    Contact Number
                                </label>
                                <input
                                    id="reg-contact" type="tel" name="contactNumber"
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="reg-email" className="text-[10px] uppercase tracking-[0.18em] font-medium" style={{ color: '#7A6E63' }}>
                                    Email Address
                                </label>
                                <input
            ...
            {showPassword ? (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <circle cx="12" cy="12" r="3"/>
                            ...
                            <label htmlFor="reg-isSeller" className="flex items-center gap-4 cursor-pointer group">
                                <div className="relative flex-shrink-0">
                                    <input
                                        id="reg-isSeller" type="checkbox" name="isSeller"
